...
CREATE TABLE `mod_jobs_employers_vacancies` (
    ...
    `salary_min_byn` decimal(15,2) unsigned DEFAULT NULL,
    `salary_max_byn` decimal(15,2) unsigned DEFAULT NULL,
    `salary_min` decimal(15,2) unsigned DEFAULT NULL,
    `salary_max` decimal(15,2) unsigned DEFAULT NULL,
...
CREATE TABLE `mod_jobs_resume` (
    ...
    `salary_byn` decimal(15,2) unsigned DEFAULT NULL,
    `salary` decimal(15,2) unsigned DEFAULT NULL,
    `currency` varchar(255) DEFAULT NULL,
    `url` varchar(500) NOT NULL,
    `last_profession` varchar(4000) DEFAULT NULL,
    `last_employer_title` varchar(4000) null,
