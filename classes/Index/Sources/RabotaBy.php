 ...
 */
class RabotaBy extends Index\Source {

    private string $base_url    = 'https://rabota.by';
    ...
    private function getProfessionsResume(): array {
        ...
        $professions      = $this->getProfessions();
        $base_url         = $this->base_url . '/search/resume?text=[TITLE]&clusters=true&area=16&currency_code=BYR&no_magic=true&ored_clusters=true&order_by=relevance&items_on_page=100&job_search_status=[STATUS]&logic=normal&pos=full_text&exp_period=all_time&page=[PAGE]&hhtmFrom=resume_search_result';
