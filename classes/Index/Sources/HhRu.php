 ...
 */
class HhRu extends Index\Source {

    private string $base_url    = 'https://hh.ru';
    ...
    private function getCategoriesVacancies(): array {
        ...
        $url = $this->base_url . '/search/vacancy?area=113&search_field=name&specialization=[SPEC]&text=&page=[PAGE]&hhtmFrom=vacancy_search_list&items_on_page=100';
    ...
    private function getProfessionsVacancies(): array {
        ...
        $base_url    = $this->base_url . '/search/vacancy?text=[TITLE]&from=suggest_post&salary=&clusters=true&area=113&no_magic=true&ored_clusters=true&items_on_page=100&enable_snippets=true&page=[PAGE]&hhtmFrom=vacancy_search_list&search_field=name';
    ...
    private function getProfessionsResume(): array {
        ...
        $professions      = $this->getProfessions();
        $base_url         = $this->base_url . '/search/resume?text=[TITLE]&clusters=true&area=113&currency_code=BYR&no_magic=true&ored_clusters=true&order_by=relevance&items_on_page=100&job_search_status=[STATUS]&logic=normal&pos=full_text&exp_period=all_time&page=[PAGE]&hhtmFrom=resume_search_result';
